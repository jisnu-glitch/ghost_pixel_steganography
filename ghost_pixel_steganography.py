...
tk.Label(sidebar, text="GHOST PIXEL", fg="white", bg="#2c3e50", font=("Arial", 14, "bold")).pack(pady=(4, 12))
tk.Button(sidebar, text="1. Load Cover Image", command=lambda: load_image(state)).pack(fill=tk.X, pady=4)
tk.Button(sidebar, text="2. Encrypt Message", command=lambda: encrypt_message(state), bg="#27ae60", fg="white").pack(fill=tk.X, pady=4)
tk.Button(sidebar, text="3. Save Encrypted Image", command=lambda: save_encrypted_image(state)).pack(fill=tk.X, pady=4)
tk.Button(sidebar, text="4. Decrypt From Image", command=lambda: decrypt_from_image(state), bg="#f39c12", fg="white").pack(fill=tk.X, pady=4)
tk.Button(sidebar, text="5. Visualize Analysis", command=lambda: show_analysis(state), bg="#2980b9", fg="white").pack(fill=tk.X, pady=(14, 4))
tk.Label(sidebar, text="Secret Message", fg="white", bg="#2c3e50", anchor="w").pack(fill=tk.X, pady=(14, 4))
